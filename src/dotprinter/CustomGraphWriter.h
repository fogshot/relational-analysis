...
#ifndef LLVM_CUSTOMGRAPHWRITER_H
#define LLVM_CUSTOMGRAPHWRITER_H
...
// TODO: this is a proof of concept -> prettify
#include "src/BlockManager.h"

using namespace llvm;
using namespace GraphProgram;

namespace bra {
    template<typename GraphType>
    class CustomGraphWriter {
        raw_ostream &O;
        const GraphType &G;
    ...
    public:
        CustomGraphWriter(raw_ostream &o, const GraphType &g, BlockManager *bmgr, bool SN) : O(o), G(g) {
...
#endif //LLVM_CUSTOMGRAPHWRITER_H
